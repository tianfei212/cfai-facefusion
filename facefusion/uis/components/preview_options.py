...
def render() -> None:
    ...
    if is_video(state_manager.get_item("target_path")):
        preview_frame_slider_options["value"] = state_manager.get_item(
            "reference_frame_number"
        )
        preview_frame_slider_options["maximum"] = count_video_frame_total(
...
def update_preview_frame_slider() -> gradio.Slider:
    if is_video(state_manager.get_item("target_path")):
        video_frame_total = count_video_frame_total(
            state_manager.get_item("target_path")
        )
