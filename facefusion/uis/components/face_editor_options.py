...
def render() -> None:
    ...
    register_ui_component(
        "face_editor_eyebrow_direction_slider", FACE_EDITOR_EYEBROW_DIRECTION_SLIDER
    )
    register_ui_component(
        "face_editor_eye_gaze_horizontal_slider", FACE_EDITOR_EYE_GAZE_HORIZONTAL_SLIDER
    )
    register_ui_component(
        "face_editor_eye_gaze_vertical_slider", FACE_EDITOR_EYE_GAZE_VERTICAL_SLIDER
    )
    register_ui_component(
        "face_editor_eye_open_ratio_slider", FACE_EDITOR_EYE_OPEN_RATIO_SLIDER
    )
    register_ui_component(
        "face_editor_lip_open_ratio_slider", FACE_EDITOR_LIP_OPEN_RATIO_SLIDER
    )
    register_ui_component(
        "face_editor_mouth_grim_slider", FACE_EDITOR_MOUTH_GRIM_SLIDER
    )
    register_ui_component(
        "face_editor_mouth_pout_slider", FACE_EDITOR_MOUTH_POUT_SLIDER
    )
    register_ui_component(
        "face_editor_mouth_purse_slider", FACE_EDITOR_MOUTH_PURSE_SLIDER
    )
    register_ui_component(
        "face_editor_mouth_smile_slider", FACE_EDITOR_MOUTH_SMILE_SLIDER
    )
    register_ui_component(
    ...
    register_ui_component(
        "face_editor_head_pitch_slider", FACE_EDITOR_HEAD_PITCH_SLIDER
    )
...
def listen() -> None:
    FACE_EDITOR_MODEL_DROPDOWN.change(
        update_face_editor_model,
        inputs=FACE_EDITOR_MODEL_DROPDOWN,
        outputs=FACE_EDITOR_MODEL_DROPDOWN,
    )
    FACE_EDITOR_EYEBROW_DIRECTION_SLIDER.release(
        update_face_editor_eyebrow_direction,
        inputs=FACE_EDITOR_EYEBROW_DIRECTION_SLIDER,
    )
    FACE_EDITOR_EYE_GAZE_HORIZONTAL_SLIDER.release(
        update_face_editor_eye_gaze_horizontal,
        inputs=FACE_EDITOR_EYE_GAZE_HORIZONTAL_SLIDER,
    )
    FACE_EDITOR_EYE_GAZE_VERTICAL_SLIDER.release(
        update_face_editor_eye_gaze_vertical,
        inputs=FACE_EDITOR_EYE_GAZE_VERTICAL_SLIDER,
    )
    FACE_EDITOR_EYE_OPEN_RATIO_SLIDER.release(
        update_face_editor_eye_open_ratio, inputs=FACE_EDITOR_EYE_OPEN_RATIO_SLIDER
    )
    FACE_EDITOR_LIP_OPEN_RATIO_SLIDER.release(
        update_face_editor_lip_open_ratio, inputs=FACE_EDITOR_LIP_OPEN_RATIO_SLIDER
    )
    FACE_EDITOR_MOUTH_GRIM_SLIDER.release(
        update_face_editor_mouth_grim, inputs=FACE_EDITOR_MOUTH_GRIM_SLIDER
    )
    FACE_EDITOR_MOUTH_POUT_SLIDER.release(
        update_face_editor_mouth_pout, inputs=FACE_EDITOR_MOUTH_POUT_SLIDER
    )
    FACE_EDITOR_MOUTH_PURSE_SLIDER.release(
        update_face_editor_mouth_purse, inputs=FACE_EDITOR_MOUTH_PURSE_SLIDER
    )
    FACE_EDITOR_MOUTH_SMILE_SLIDER.release(
        update_face_editor_mouth_smile, inputs=FACE_EDITOR_MOUTH_SMILE_SLIDER
    )
    FACE_EDITOR_MOUTH_POSITION_HORIZONTAL_SLIDER.release(
        update_face_editor_mouth_position_horizontal,
        inputs=FACE_EDITOR_MOUTH_POSITION_HORIZONTAL_SLIDER,
    )
    FACE_EDITOR_MOUTH_POSITION_VERTICAL_SLIDER.release(
        update_face_editor_mouth_position_vertical,
        inputs=FACE_EDITOR_MOUTH_POSITION_VERTICAL_SLIDER,
    )
    FACE_EDITOR_HEAD_PITCH_SLIDER.release(
        update_face_editor_head_pitch, inputs=FACE_EDITOR_HEAD_PITCH_SLIDER
    )
    FACE_EDITOR_HEAD_YAW_SLIDER.release(
        update_face_editor_head_yaw, inputs=FACE_EDITOR_HEAD_YAW_SLIDER
    )
    FACE_EDITOR_HEAD_ROLL_SLIDER.release(
        update_face_editor_head_roll, inputs=FACE_EDITOR_HEAD_ROLL_SLIDER
    )
...
def remote_update(
    ...
    return (
        gradio.Dropdown(visible=has_face_editor),
        gradio.Slider(visible=has_face_editor),
        gradio.Slider(visible=has_face_editor),
        gradio.Slider(visible=has_face_editor),
        gradio.Slider(visible=has_face_editor),
        gradio.Slider(visible=has_face_editor),
...
def update_face_editor_eye_gaze_horizontal(
    face_editor_eye_gaze_horizontal: float,
) -> None:
    state_manager.set_item(
        "face_editor_eye_gaze_horizontal", face_editor_eye_gaze_horizontal
    )


def update_face_editor_eye_gaze_vertical(face_editor_eye_gaze_vertical: float) -> None:
    state_manager.set_item(
        "face_editor_eye_gaze_vertical", face_editor_eye_gaze_vertical
    )
...
def update_face_editor_mouth_position_horizontal(
...
def update_face_editor_mouth_position_vertical(
