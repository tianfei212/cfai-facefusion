...
from facefusion.processors.live_portrait import (
    create_rotation,
    limit_angle,
    limit_expression,
)
from facefusion.processors.types import (
    ...
    LivePortraitFeatureVolume,
    LivePortraitMotionPoints,
    LivePortraitPitch,
    LivePortraitRoll,
    LivePortraitRotation,
    LivePortraitScale,
    ...
    return {
        "live_portrait": {
            "hashes": {
                "feature_extractor": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_feature_extractor.hash"
                    ),
                ...
                "motion_extractor": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_motion_extractor.hash"
                    ),
                    "path": resolve_relative_path(
                ...
                "eye_retargeter": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_eye_retargeter.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_eye_retargeter.hash"
                    ),
                },
                "lip_retargeter": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_lip_retargeter.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_lip_retargeter.hash"
                    ),
                },
                "stitcher": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_stitcher.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_stitcher.hash"
                    ),
                },
                "generator": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_generator.hash"
                    ),
                    "path": resolve_relative_path(
            ...
            "sources": {
                "feature_extractor": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_feature_extractor.onnx"
                    ),
                    "path": resolve_relative_path(
                ...
                "motion_extractor": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_motion_extractor.onnx"
                    ),
                    "path": resolve_relative_path(
                ...
                "eye_retargeter": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_eye_retargeter.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_eye_retargeter.onnx"
                    ),
                },
                "lip_retargeter": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_lip_retargeter.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_lip_retargeter.onnx"
                    ),
                },
                "stitcher": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_stitcher.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/live_portrait_stitcher.onnx"
                    ),
                },
                "generator": {
                    "url": resolve_download_url(
                        "models-3.0.0", "live_portrait_generator.onnx"
                    ),
                    "path": resolve_relative_path(
    ...
    if group_processors:
        group_processors.add_argument(
            ...
            default=config.get_str_value(
                "processors", "face_editor_model", "live_portrait"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_eyebrow_direction", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_eye_gaze_horizontal", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_eye_gaze_vertical", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_eye_open_ratio", "0"
            ),
            choices=processors_choices.face_editor_eye_open_ratio_range,
            metavar=create_float_metavar(
                processors_choices.face_editor_eye_open_ratio_range
            ),
        )
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_lip_open_ratio", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            metavar=create_float_metavar(
                processors_choices.face_editor_mouth_pout_range
            ),
        )
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_mouth_purse", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_mouth_smile", "0"
            ),
            choices=processors_choices.face_editor_mouth_smile_range,
            metavar=create_float_metavar(
                processors_choices.face_editor_mouth_smile_range
            ),
        )
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_mouth_position_horizontal", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            type=float,
            default=config.get_float_value(
                "processors", "face_editor_mouth_position_vertical", "0"
            ),
        ...
        group_processors.add_argument(
            ...
            metavar=create_float_metavar(
                processors_choices.face_editor_head_pitch_range
            ),
        )
        group_processors.add_argument(
        ...
        group_processors.add_argument(
            ...
            metavar=create_float_metavar(
                processors_choices.face_editor_head_roll_range
            ),
        )
...
def apply_args(args: Args, apply_state_item: ApplyStateItem) -> None:
    ...
    apply_state_item(
        "face_editor_eyebrow_direction", args.get("face_editor_eyebrow_direction")
    )
    apply_state_item(
        "face_editor_eye_gaze_horizontal", args.get("face_editor_eye_gaze_horizontal")
    )
    apply_state_item(
        "face_editor_eye_gaze_vertical", args.get("face_editor_eye_gaze_vertical")
    )
    apply_state_item(
        "face_editor_eye_open_ratio", args.get("face_editor_eye_open_ratio")
    )
    apply_state_item(
        "face_editor_lip_open_ratio", args.get("face_editor_lip_open_ratio")
    )
    ...
    apply_state_item(
        "face_editor_mouth_position_vertical",
        args.get("face_editor_mouth_position_vertical"),
    )
...
def edit_face(target_face: Face, temp_vision_frame: VisionFrame) -> VisionFrame:
    ...
    crop_vision_frame, affine_matrix = warp_face_by_face_landmark_5(
        temp_vision_frame, face_landmark_5, model_template, model_size
    )
    box_mask = create_box_mask(
        crop_vision_frame, state_manager.get_item("face_mask_blur"), (0, 0, 0, 0)
    )
    crop_vision_frame = prepare_crop_frame(crop_vision_frame)
    crop_vision_frame = apply_edit(
        crop_vision_frame, target_face.landmark_set.get("68")
    )
    crop_vision_frame = normalize_crop_frame(crop_vision_frame)
    paste_vision_frame = paste_back(
        temp_vision_frame, crop_vision_frame, box_mask, affine_matrix
    )
    return paste_vision_frame


def apply_edit(
    crop_vision_frame: VisionFrame, face_landmark_68: FaceLandmark68
) -> VisionFrame:
    feature_volume = forward_extract_feature(crop_vision_frame)
    pitch, yaw, roll, scale, translation, expression, motion_points = (
        forward_extract_motion(crop_vision_frame)
    )
    rotation = create_rotation(pitch, yaw, roll)
    motion_points_target = (
        scale * (motion_points @ rotation.T + expression) + translation
    )
    ...
    motion_points_source = forward_stitch_motion_points(
        motion_points_source, motion_points_target
    )
    crop_vision_frame = forward_generate_frame(
        feature_volume, motion_points_source, motion_points_target
    )
    return crop_vision_frame


def forward_extract_feature(
...
def forward_extract_motion(
    ...
    with conditional_thread_semaphore():
        pitch, yaw, roll, scale, translation, expression, motion_points = (
            motion_extractor.run(None, {"input": crop_vision_frame})
        )

    return pitch, yaw, roll, scale, translation, expression, motion_points


def forward_retarget_eye(
    eye_motion_points: LivePortraitMotionPoints,
) -> LivePortraitMotionPoints:
    eye_retargeter = get_inference_pool().get("eye_retargeter")

    with conditional_thread_semaphore():
        eye_motion_points = eye_retargeter.run(None, {"input": eye_motion_points})[0]

    return eye_motion_points


def forward_retarget_lip(
    lip_motion_points: LivePortraitMotionPoints,
) -> LivePortraitMotionPoints:
    lip_retargeter = get_inference_pool().get("lip_retargeter")

    with conditional_thread_semaphore():
        lip_motion_points = lip_retargeter.run(None, {"input": lip_motion_points})[0]

    return lip_motion_points


def forward_stitch_motion_points(
    ...
    with thread_semaphore():
        motion_points = stitcher.run(
            None, {"source": source_motion_points, "target": target_motion_points}
        )[0]
...
def forward_generate_frame(
    feature_volume: LivePortraitFeatureVolume,
    source_motion_points: LivePortraitMotionPoints,
    target_motion_points: LivePortraitMotionPoints,
) -> VisionFrame:
...
def edit_eyebrow_direction(
    ...
    if face_editor_eyebrow > 0:
        expression[0, 1, 1] += numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.015, 0.015]
        )
        expression[0, 2, 1] -= numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.020, 0.020]
        )
    else:
        expression[0, 1, 0] -= numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.015, 0.015]
        )
        expression[0, 2, 0] += numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.020, 0.020]
        )
        expression[0, 1, 1] += numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.005, 0.005]
        )
        expression[0, 2, 1] -= numpy.interp(
            face_editor_eyebrow, [-1, 1], [-0.005, 0.005]
        )
...
def edit_eye_gaze(expression: LivePortraitExpression) -> LivePortraitExpression:
    face_editor_eye_gaze_horizontal = state_manager.get_item(
        "face_editor_eye_gaze_horizontal"
    )
    face_editor_eye_gaze_vertical = state_manager.get_item(
        "face_editor_eye_gaze_vertical"
    )

    if face_editor_eye_gaze_horizontal > 0:
        expression[0, 11, 0] += numpy.interp(
            face_editor_eye_gaze_horizontal, [-1, 1], [-0.015, 0.015]
        )
        expression[0, 15, 0] += numpy.interp(
            face_editor_eye_gaze_horizontal, [-1, 1], [-0.020, 0.020]
        )
    else:
        expression[0, 11, 0] += numpy.interp(
            face_editor_eye_gaze_horizontal, [-1, 1], [-0.020, 0.020]
    ...
    expression[0, 1, 1] += numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.0025, 0.0025]
    )
    expression[0, 2, 1] -= numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.0025, 0.0025]
    )
    expression[0, 11, 1] -= numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.010, 0.010]
    )
    expression[0, 13, 1] -= numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.005, 0.005]
    )
    expression[0, 15, 1] -= numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.010, 0.010]
    )
    expression[0, 16, 1] -= numpy.interp(
        face_editor_eye_gaze_vertical, [-1, 1], [-0.005, 0.005]
    )
    return expression
...
def edit_eye_open(
    motion_points: LivePortraitMotionPoints, face_landmark_68: FaceLandmark68
) -> LivePortraitMotionPoints:
    ...
    if face_editor_eye_open_ratio < 0:
        eye_motion_points = numpy.concatenate(
            [motion_points.ravel(), [left_eye_ratio, right_eye_ratio, 0.0]]
        )
    else:
        eye_motion_points = numpy.concatenate(
            [motion_points.ravel(), [left_eye_ratio, right_eye_ratio, 0.6]]
        )
    eye_motion_points = eye_motion_points.reshape(1, -1).astype(numpy.float32)
    eye_motion_points = forward_retarget_eye(eye_motion_points) * numpy.abs(
        face_editor_eye_open_ratio
    )
...
def edit_lip_open(
    ...
    lip_motion_points = forward_retarget_lip(lip_motion_points) * numpy.abs(
        face_editor_lip_open_ratio
    )
...
def edit_mouth_grim(expression: LivePortraitExpression) -> LivePortraitExpression:
    ...
    if face_editor_mouth_grim > 0:
        expression[0, 17, 2] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.005, 0.005]
        )
        expression[0, 19, 2] += numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.01, 0.01]
        )
        expression[0, 20, 1] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.06, 0.06]
        )
        expression[0, 20, 2] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.03, 0.03]
        )
    else:
        expression[0, 19, 1] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.05, 0.05]
        )
        expression[0, 19, 2] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.02, 0.02]
        )
        expression[0, 20, 2] -= numpy.interp(
            face_editor_mouth_grim, [-1, 1], [-0.03, 0.03]
        )
...
def edit_mouth_position(expression: LivePortraitExpression) -> LivePortraitExpression:
    face_editor_mouth_position_horizontal = state_manager.get_item(
        "face_editor_mouth_position_horizontal"
    )
    face_editor_mouth_position_vertical = state_manager.get_item(
        "face_editor_mouth_position_vertical"
    )
    expression[0, 19, 0] += numpy.interp(
        face_editor_mouth_position_horizontal, [-1, 1], [-0.05, 0.05]
    )
    expression[0, 20, 0] += numpy.interp(
        face_editor_mouth_position_horizontal, [-1, 1], [-0.04, 0.04]
    )
    if face_editor_mouth_position_vertical > 0:
        expression[0, 19, 1] -= numpy.interp(
            face_editor_mouth_position_vertical, [-1, 1], [-0.04, 0.04]
        )
        expression[0, 20, 1] -= numpy.interp(
            face_editor_mouth_position_vertical, [-1, 1], [-0.02, 0.02]
        )
    else:
        expression[0, 19, 1] -= numpy.interp(
            face_editor_mouth_position_vertical, [-1, 1], [-0.05, 0.05]
        )
        expression[0, 20, 1] -= numpy.interp(
            face_editor_mouth_position_vertical, [-1, 1], [-0.04, 0.04]
        )
...
def edit_mouth_pout(expression: LivePortraitExpression) -> LivePortraitExpression:
    ...
    if face_editor_mouth_pout > 0:
        expression[0, 19, 1] -= numpy.interp(
            face_editor_mouth_pout, [-1, 1], [-0.022, 0.022]
        )
        expression[0, 19, 2] += numpy.interp(
            face_editor_mouth_pout, [-1, 1], [-0.025, 0.025]
        )
        expression[0, 20, 2] -= numpy.interp(
            face_editor_mouth_pout, [-1, 1], [-0.002, 0.002]
        )
    else:
        expression[0, 19, 1] += numpy.interp(
            face_editor_mouth_pout, [-1, 1], [-0.022, 0.022]
...
def edit_mouth_purse(expression: LivePortraitExpression) -> LivePortraitExpression:
    ...
    if face_editor_mouth_purse > 0:
        expression[0, 19, 1] -= numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.04, 0.04]
        )
        expression[0, 19, 2] -= numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.02, 0.02]
        )
    else:
        expression[0, 14, 1] -= numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.02, 0.02]
        )
        expression[0, 17, 2] += numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.01, 0.01]
        )
        expression[0, 19, 2] -= numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.015, 0.015]
        )
        expression[0, 20, 2] -= numpy.interp(
            face_editor_mouth_purse, [-1, 1], [-0.002, 0.002]
        )
    return expression
...
def edit_mouth_smile(expression: LivePortraitExpression) -> LivePortraitExpression:
    ...
    if face_editor_mouth_smile > 0:
        expression[0, 20, 1] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.015, 0.015]
        )
        expression[0, 14, 1] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.025, 0.025]
        )
        expression[0, 17, 1] += numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.01, 0.01]
        )
        expression[0, 17, 2] += numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.004, 0.004]
        )
        expression[0, 3, 1] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.0045, 0.0045]
        )
        expression[0, 7, 1] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.0045, 0.0045]
        )
    else:
        expression[0, 14, 1] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.02, 0.02]
        )
        expression[0, 17, 1] += numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.003, 0.003]
        )
        expression[0, 19, 1] += numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.02, 0.02]
        )
        expression[0, 19, 2] -= numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.005, 0.005]
        )
        expression[0, 20, 2] += numpy.interp(
            face_editor_mouth_smile, [-1, 1], [-0.01, 0.01]
        )
...
def edit_head_rotation(
    ...
    edit_pitch, edit_yaw, edit_roll = limit_angle(
        pitch, yaw, roll, edit_pitch, edit_yaw, edit_roll
    )
...
def calculate_distance_ratio(
    ...
    distance_ratio = float(
        numpy.linalg.norm(vertical_direction)
        / (numpy.linalg.norm(horizontal_direction) + 1e-6)
    )
...
def prepare_crop_frame(crop_vision_frame: VisionFrame) -> VisionFrame:
    ...
    crop_vision_frame = cv2.resize(
        crop_vision_frame, prepare_size, interpolation=cv2.INTER_AREA
    )
...
def process_frame(inputs: FaceEditorInputs) -> VisionFrame:
    ...
    if target_faces:
        for target_face in target_faces:
            target_face = scale_face(
                target_face, target_vision_frame, temp_vision_frame
            )
