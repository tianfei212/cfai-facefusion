    ...
    return {
            ...
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "clear_reality_x4.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/clear_reality_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "clear_reality_x4.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/clear_reality_x4.onnx"
                    ),
                }
            },
            "size": (128, 8, 4),
        ...
        "nomos8k_sc_x4": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/nomos8k_sc_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/nomos8k_sc_x4.onnx"
                    ),
                }
            },
            "size": (128, 8, 4),
        ...
        "real_esrgan_x2": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x2.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x2.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_esrgan_x2_fp16": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "real_esrgan_x2_fp16.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x2_fp16.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x2_fp16.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_esrgan_x4": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x4.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_esrgan_x4_fp16": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "real_esrgan_x4_fp16.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x4_fp16.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x4_fp16.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_esrgan_x8": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x8.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x8.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_esrgan_x8_fp16": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "real_esrgan_x8_fp16.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x8_fp16.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "real_esrgan_x8_fp16.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_esrgan_x8_fp16.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_hatgan_x4": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_hatgan_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/real_hatgan_x4.onnx"
                    ),
                }
            },
            "size": (256, 16, 8),
        ...
        "real_web_photo_x4": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.1.0", "real_web_photo_x4.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_web_photo_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.1.0", "real_web_photo_x4.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/real_web_photo_x4.onnx"
                    ),
                }
            },
            "size": (64, 4, 2),
        ...
        "realistic_rescaler_x4": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.1.0", "realistic_rescaler_x4.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/realistic_rescaler_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.1.0", "realistic_rescaler_x4.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/realistic_rescaler_x4.onnx"
                    ),
                }
            },
            "size": (128, 8, 4),
        ...
        "span_kendata_x4": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/span_kendata_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/span_kendata_x4.onnx"
                    ),
                }
            },
            "size": (128, 8, 4),
        ...
        "ultra_sharp_x4": {
            "hashes": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/ultra_sharp_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/ultra_sharp_x4.onnx"
                    ),
                }
            },
            "size": (128, 8, 4),
        ...
        "ultra_sharp_2_x4": {
            "hashes": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.3.0", "ultra_sharp_2_x4.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/ultra_sharp_2_x4.hash"
                    ),
                }
            },
            "sources": {
                "frame_enhancer": {
                    "url": resolve_download_url(
                        "models-3.3.0", "ultra_sharp_2_x4.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/ultra_sharp_2_x4.onnx"
                    ),
                }
            },
            "size": (1024, 64, 32),
    ...
    if group_processors:
        group_processors.add_argument(
            ...
            default=config.get_str_value(
                "processors", "frame_enhancer_model", "span_kendata_x4"
            ),
...
def enhance_frame(temp_vision_frame: VisionFrame) -> VisionFrame:
    ...
    merge_vision_frame = merge_tile_frames(
        ...
        (
            model_size[0] * model_scale,
            model_size[1] * model_scale,
...
def blend_merge_frame(
    ...
    temp_vision_frame = blend_frame(
        temp_vision_frame, merge_vision_frame, 1 - frame_enhancer_blend
    )
    return temp_vision_frame
