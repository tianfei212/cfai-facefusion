            ...
            "hashes": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_256.hash"
                    ),
                }
            },
            "sources": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_256.onnx"
                    ),
                }
            },
        ...
        "gpen_bfr_512": {
            "hashes": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_512.hash"
                    ),
                }
            },
            "sources": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_512.onnx"
                    ),
                }
            },
            "template": "ffhq_512",
        ...
        "gpen_bfr_1024": {
            "hashes": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_1024.hash"
                    ),
                }
            },
            "sources": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_1024.onnx"
                    ),
                }
            },
            "template": "ffhq_512",
        ...
        "gpen_bfr_2048": {
            "hashes": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_2048.hash"
                    ),
                }
            },
            "sources": {
                "face_enhancer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/gpen_bfr_2048.onnx"
                    ),
                }
            },
            "template": "ffhq_512",
            ...
            "hashes": {
                "face_enhancer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "restoreformer_plus_plus.hash"
                    ),
                    "path": resolve_relative_path(
    ...
    if group_processors:
        group_processors.add_argument(
            ...
            default=config.get_str_value(
                "processors", "face_enhancer_model", "gfpgan_1.4"
            ),
        ...
        group_processors.add_argument(
            ...
            help=wording.get("help.face_enhancer_weight"),
            type=float,
            default=config.get_float_value("processors", "face_enhancer_weight", "0.5"),
            choices=processors_choices.face_enhancer_weight_range,
            metavar=create_float_metavar(processors_choices.face_enhancer_weight_range),
        )
...
def enhance_face(target_face: Face, temp_vision_frame: VisionFrame) -> VisionFrame:
    ...
    face_enhancer_weight = numpy.array(
        [state_manager.get_item("face_enhancer_weight")]
    ).astype(numpy.double)
...
def forward(
    crop_vision_frame: VisionFrame, face_enhancer_weight: FaceEnhancerWeight
) -> VisionFrame:
...
def blend_paste_frame(
    ...
    temp_vision_frame = blend_frame(
        temp_vision_frame, paste_vision_frame, 1 - face_enhancer_blend
    )
    return temp_vision_frame
