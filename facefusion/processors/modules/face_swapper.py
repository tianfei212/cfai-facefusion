    ...
    return {
            ...
            "hashes": {
                "face_swapper": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/blendswap_256.hash"
                    ),
                }
            },
            "sources": {
                "face_swapper": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/blendswap_256.onnx"
                    ),
                }
            },
            "type": "blendswap",
        ...
        "ghost_1_256": {
            "hashes": {
                ...
                "embedding_converter": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_ghost.hash"
                    ),
                },
            },
            "sources": {
                ...
                "embedding_converter": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_ghost.onnx"
                    ),
                },
            },
            "type": "ghost",
            ...
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.1.0", "hififace_unofficial_256.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/hififace_unofficial_256.hash"
                    ),
                },
                "embedding_converter": {
                    "url": resolve_download_url(
                        "models-3.4.0", "crossface_hififace.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_hififace.hash"
                    ),
                },
            },
            "sources": {
                "face_swapper": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/hififace_unofficial_256.onnx"
                    ),
                },
                "embedding_converter": {
                    "url": resolve_download_url(
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_hififace.onnx"
                    ),
                },
            },
            "type": "hififace",
        ...
        "hyperswap_1a_256": {
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.3.0", "hyperswap_1a_256.hash"
                    ),
                    "path": resolve_relative_path(
        ...
        "hyperswap_1b_256": {
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.3.0", "hyperswap_1b_256.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/hyperswap_1b_256.hash"
                    ),
                }
            },
            "sources": {
                "face_swapper": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/hyperswap_1b_256.onnx"
                    ),
                }
            },
            "type": "hyperswap",
        ...
        "hyperswap_1c_256": {
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.3.0", "hyperswap_1c_256.hash"
                    ),
                    "path": resolve_relative_path(
        ...
        "inswapper_128_fp16": {
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.0.0", "inswapper_128_fp16.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/inswapper_128_fp16.hash"
                    ),
                }
            },
            "sources": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.0.0", "inswapper_128_fp16.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/inswapper_128_fp16.onnx"
                    ),
                }
            },
            "type": "inswapper",
        ...
        "simswap_256": {
            "hashes": {
                ...
                "embedding_converter": {
                    "url": resolve_download_url(
                        "models-3.4.0", "crossface_simswap.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_simswap.hash"
                    ),
                },
            },
            "sources": {
                ...
                "embedding_converter": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/crossface_simswap.onnx"
                    ),
                },
            },
            "type": "simswap",
        ...
        "simswap_unofficial_512": {
            "hashes": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.0.0", "simswap_unofficial_512.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/simswap_unofficial_512.hash"
                    ),
                },
                "embedding_converter": {
                    "url": resolve_download_url(
            ...
            "sources": {
                "face_swapper": {
                    "url": resolve_download_url(
                        "models-3.0.0", "simswap_unofficial_512.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/simswap_unofficial_512.onnx"
                    ),
                },
                "embedding_converter": {
                    "url": resolve_download_url(
...
def get_model_name() -> str:
    ...
    if (
        is_macos()
        and has_execution_provider("coreml")
        and model_name == "inswapper_128_fp16"
    ):
    ...
    if group_processors:
        group_processors.add_argument(
            ...
            default=config.get_str_value(
                "processors", "face_swapper_model", "inswapper_128_fp16"
            ),
        ...
        group_processors.add_argument(
            "--face-swapper-weight",
            help=wording.get("help.face_swapper_weight"),
            type=float,
...
def pre_process(mode: ProcessMode) -> bool:
    if not has_image(state_manager.get_item("source_paths")):
        logger.error(
            wording.get("choose_image_source") + wording.get("exclamation_mark"),
            __name__,
        )
        return False
    ...
    if not get_one_face(source_faces):
        logger.error(
            wording.get("no_source_face_detected") + wording.get("exclamation_mark"),
            __name__,
        )
        return False
...
def swap_face(
    ...
    pixel_boost_size = unpack_resolution(
        state_manager.get_item("face_swapper_pixel_boost")
    )
    ...
    for pixel_boost_vision_frame in pixel_boost_vision_frames:
        ...
        pixel_boost_vision_frame = forward_swap_face(
            source_face, target_face, pixel_boost_vision_frame
        )
    ...
    if "area" in state_manager.get_item("face_mask_types"):
        face_landmark_68 = cv2.transform(
            target_face.landmark_set.get("68").reshape(1, -1, 2), affine_matrix
        ).reshape(-1, 2)
        area_mask = create_area_mask(
            crop_vision_frame,
            face_landmark_68,
    ...
    if "region" in state_manager.get_item("face_mask_types"):
        region_mask = create_region_mask(
            crop_vision_frame, state_manager.get_item("face_mask_regions")
        )
...
def forward_swap_face(
    source_face: Face, target_face: Face, crop_vision_frame: VisionFrame
) -> VisionFrame:
    ...
    if (
        is_macos()
        and has_execution_provider("coreml")
        and model_type in ["ghost", "uniface"]
    ):
        face_swapper.set_providers(
    ...
    for face_swapper_input in face_swapper.get_inputs():
        if face_swapper_input.name == "source":
            if model_type in ["blendswap", "uniface"]:
                ...
                source_embedding = balance_source_embedding(
                    source_embedding, target_face.embedding
                )
...
def forward_convert_embedding(face_embedding: Embedding) -> Embedding:
    ...
    with conditional_thread_semaphore():
        face_embedding = embedding_converter.run(None, {"input": face_embedding})[0]
...
def prepare_source_frame(source_face: Face) -> VisionFrame:
    ...
    source_vision_frame = read_static_image(
        get_first(state_manager.get_item("source_paths"))
    )
...
def balance_source_embedding(
    ...
    face_swapper_weight = numpy.interp(
        face_swapper_weight, [0, 1], [0.35, -0.35]
    ...
    source_embedding = (
        source_embedding * (1 - face_swapper_weight)
        + target_embedding * face_swapper_weight
    )
    return source_embedding


def convert_source_embedding(
