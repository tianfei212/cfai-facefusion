    ...
    return {
            ...
            "hashes": {
                "frame_colorizer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "ddcolor_artistic.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/ddcolor_artistic.hash"
                    ),
                }
            },
            "sources": {
                "frame_colorizer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "ddcolor_artistic.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/ddcolor_artistic.onnx"
                    ),
                }
            },
            "type": "ddcolor",
        ...
        "deoldify_artistic": {
            "hashes": {
                "frame_colorizer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "deoldify_artistic.hash"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/deoldify_artistic.hash"
                    ),
                }
            },
            "sources": {
                "frame_colorizer": {
                    "url": resolve_download_url(
                        "models-3.0.0", "deoldify_artistic.onnx"
                    ),
                    "path": resolve_relative_path(
                        "../.assets/models/deoldify_artistic.onnx"
                    ),
                }
            },
            "type": "deoldify",
        ...
        "deoldify_stable": {
            "hashes": {
                "frame_colorizer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/deoldify_stable.hash"
                    ),
                }
            },
            "sources": {
                "frame_colorizer": {
                    ...
                    "path": resolve_relative_path(
                        "../.assets/models/deoldify_stable.onnx"
                    ),
                }
            },
            "type": "deoldify",
    ...
    if group_processors:
        group_processors.add_argument(
            ...
            default=config.get_str_value(
                "processors", "frame_colorizer_model", "ddcolor"
            ),
            choices=processors_choices.frame_colorizer_models,
        )
        group_processors.add_argument(
            "--frame-colorizer-size",
            help=wording.get("help.frame_colorizer_size"),
            type=str,
            default=config.get_str_value(
                "processors", "frame_colorizer_size", "256x256"
            ),
...
def forward(color_vision_frame: VisionFrame) -> VisionFrame:
    ...
    with thread_semaphore():
        color_vision_frame = frame_colorizer.run(None, {"input": color_vision_frame})[
            0
        ][0]
