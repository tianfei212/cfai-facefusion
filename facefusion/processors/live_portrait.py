...
def limit_angle(
    target_pitch: LivePortraitPitch,
    target_yaw: LivePortraitYaw,
    target_roll: LivePortraitRoll,
    output_pitch: LivePortraitPitch,
    output_yaw: LivePortraitYaw,
    output_roll: LivePortraitRoll,
) -> Tuple[LivePortraitPitch, LivePortraitYaw, LivePortraitRoll]:
    pitch_min, pitch_max, yaw_min, yaw_max, roll_min, roll_max = calculate_euler_limits(
