...
FrameColorizerModel = Literal[
    "ddcolor", "ddcolor_artistic", "deoldify", "deoldify_artistic", "deoldify_stable"
]
...
FrameColorizerInputs = TypedDict(
    ...
    {"target_vision_frame": VisionFrame, "temp_vision_frame": VisionFrame},
)
