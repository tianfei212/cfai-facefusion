...
def test_has_audio() -> None:
    ...
    assert (
        has_audio(
            [get_test_example_file("source.mp3"), get_test_example_file("source.jpg")]
        )
        is True
    )
    assert (
        has_audio(
            [get_test_example_file("source.jpg"), get_test_example_file("source.jpg")]
        )
        is False
    )
...
def test_has_image() -> None:
    ...
    assert (
        has_image(
            [get_test_example_file("source.jpg"), get_test_example_file("source.mp3")]
        )
        is True
    )
    assert (
        has_image(
            [get_test_example_file("source.mp3"), get_test_example_file("source.mp3")]
        )
        is False
    )
...
def test_create_directory() -> None:
    create_directory_path = os.path.join(
        get_test_outputs_directory(), "create_directory"
    )
...
def test_remove_directory() -> None:
    remove_directory_path = os.path.join(
        get_test_outputs_directory(), "remove_directory"
    )
