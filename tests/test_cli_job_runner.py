...
def test_job_run() -> None:
    ...
    commands = [
        ...
        get_test_example_file("target-240p.jpg"),
        "-o",
        get_test_output_file("test-job-run.jpg"),
    ]
    subprocess.run(commands)
...
def test_job_run_all() -> None:
    ...
    commands = [
        ...
        get_test_example_file("target-240p.jpg"),
        "-o",
        get_test_output_file("test-job-run-all-1.jpg"),
    ]
    subprocess.run(commands)
    ...
    commands = [
        ...
        get_test_example_file("target-240p.mp4"),
        "-o",
        get_test_output_file("test-job-run-all-2.mp4"),
        "--trim-frame-end",
        "1",
    ]
    subprocess.run(commands)
...
def test_job_retry() -> None:
    ...
    commands = [
        ...
        get_test_example_file("target-240p.jpg"),
        "-o",
        get_test_output_file("test-job-retry.jpg"),
    ]
    subprocess.run(commands)
...
def test_job_retry_all() -> None:
    ...
    commands = [
        ...
        get_test_example_file("target-240p.jpg"),
        "-o",
        get_test_output_file("test-job-retry-all-1.jpg"),
    ]
    subprocess.run(commands)
    ...
    commands = [
        ...
        get_test_example_file("target-240p.mp4"),
        "-o",
        get_test_output_file("test-job-retry-all-2.mp4"),
        "--trim-frame-end",
        "1",
    ]
    subprocess.run(commands)
