...
from facefusion.jobs.job_manager import (
    add_step,
    clear_jobs,
    create_job,
    init_jobs,
...
from facefusion.jobs.job_runner import (
    collect_output_set,
    finalize_steps,
    retry_job,
    retry_jobs,
...
def test_finalize_steps() -> None:
    ...
    copy_file(
        args_1.get("target_path"),
        get_test_output_file("output-1-job-test-finalize-steps-0.mp4"),
    )
    copy_file(
        args_1.get("target_path"),
        get_test_output_file("output-1-job-test-finalize-steps-1.mp4"),
    )
    copy_file(
        args_2.get("target_path"),
        get_test_output_file("output-2-job-test-finalize-steps-2.mp4"),
    )
    copy_file(
        args_3.get("target_path"),
        get_test_output_file("output-3-job-test-finalize-steps-3.jpg"),
    )
