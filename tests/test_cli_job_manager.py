...
def test_job_submit() -> None:
    ...
    commands = [
        ...
        get_test_example_file("target-240p.jpg"),
        "-o",
        get_test_output_file("test-job-remix-step.jpg"),
    ]
    subprocess.run(commands)
