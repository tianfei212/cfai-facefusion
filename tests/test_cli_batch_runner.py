...
def before_all() -> None:
    ...
    subprocess.run(
        [
            ...
            "-vframes",
            "1",
            get_test_example_file("target-240p-batch-1.jpg"),
        ]
    )
    subprocess.run(
        [
            ...
            "-vframes",
            "2",
            get_test_example_file("target-240p-batch-2.jpg"),
        ]
    )
...
def test_batch_run_targets() -> None:
    commands = [
        ...
        "-o",
        get_test_output_file("test-batch-run-targets-{index}.jpg"),
    ]
...
def test_batch_run_sources_to_targets() -> None:
    commands = [
        ...
        get_test_example_file("target-240p-batch-*.jpg"),
        "-o",
        get_test_output_file("test-batch-run-sources-to-targets-{index}.jpg"),
    ]
